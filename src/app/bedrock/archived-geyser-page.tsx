/*
  ARCHIVED: original Bedrock / GeyserMC "How to Join" page.
  Preserved 2026-04-19 while /bedrock is replaced by an interest poll.
  To restore: rename this file to `page.tsx` (delete the current poll page first).

  Not routed by Next.js — only `page.tsx` in this folder is treated as a route.
*/
'use client';
